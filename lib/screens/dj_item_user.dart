...
class UserItemPage extends StatefulWidget {
  ...
  @override
  _UserItemPageState createState() => _UserItemPageState();
}
...
class _UserItemPageState extends State<UserItemPage> {
  ...
  Future<List<AirJordan>> fetchItem() async {
    var url = Uri.parse('https://martin-marcelino-tugas.pbp.cs.ui.ac.id/json-user/${loggedInUser.username}');
